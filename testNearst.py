...
from Utils import *
import FactorBP.FindNearSol as NearSol
...
G2,MFname = FB.ConstructMatchingModel(MG1, MG2, 'pas', False, True)
...
G2,MFname = FB.ConstructMatchingModel(MG1, MG2, 'pas', False)

X0 = np.random.permutation(NofNodes)
X1=NearSol.FindNearSol(NofNodes, G2, X0, 3, 100)
